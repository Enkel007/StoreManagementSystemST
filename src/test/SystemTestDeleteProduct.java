...
public class SystemTestDeleteProduct extends ApplicationTest {
    Button loginButton;
    ...
    @Test
    public void should_cancel_delete_first_product() throws SQLException {
        ...
        deleteProductButton = lookup(".button.danger.xs").nth(0).queryAs(Button.class);
